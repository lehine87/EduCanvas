  ...
  public: {
    Tables: {
      ...
      class_classroom_schedules: {
        ...
        Relationships: [
          {
            foreignKeyName: "class_classroom_schedules_class_id_fkey"
            columns: ["class_id"]
            isOneToOne: false
            referencedRelation: "classes"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "class_classroom_schedules_classroom_id_fkey"
          ...
          {
            foreignKeyName: "class_classroom_schedules_created_by_fkey"
            columns: ["created_by"]
            isOneToOne: false
            referencedRelation: "user_profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "class_classroom_schedules_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "class_classroom_schedules_time_slot_id_fkey"
      ...
      classes: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "classes_default_classroom_id_fkey"
      ...
      classrooms: {
        Row: {
          ...
          capacity: number
          classroom_type: Database["public"]["Enums"]["classroom_type"] | null
          created_at: string | null
          description: string | null
      ...
      temporary_classroom_changes: {
        Row: {
          ...
          reason: Database["public"]["Enums"]["classroom_change_reason"]
          reason_description: string | null
          requested_by: string
          start_time: string | null
          status: string | null
          temporary_classroom_id: string | null
          tenant_id: string | null
          time_slot_id: string | null
          updated_at: string | null
        }
        ...
        Relationships: [
          {
            foreignKeyName: "temporary_classroom_changes_approved_by_fkey"
            columns: ["approved_by"]
            isOneToOne: false
            referencedRelation: "user_profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "temporary_classroom_changes_class_id_fkey"
            columns: ["class_id"]
            isOneToOne: false
            referencedRelation: "classes"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "temporary_classroom_changes_original_classroom_id_fkey"
          ...
          {
            foreignKeyName: "temporary_classroom_changes_original_schedule_id_fkey"
            columns: ["original_schedule_id"]
            isOneToOne: false
            referencedRelation: "class_classroom_schedules"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "temporary_classroom_changes_requested_by_fkey"
          ...
          {
            foreignKeyName: "temporary_classroom_changes_temporary_classroom_id_fkey"
            columns: ["temporary_classroom_id"]
            isOneToOne: false
            referencedRelation: "classrooms"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "temporary_classroom_changes_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "temporary_classroom_changes_time_slot_id_fkey"
            columns: ["time_slot_id"]
            isOneToOne: false
            referencedRelation: "time_slots"
            referencedColumns: ["id"]
      ...
      tenant_subjects: {
        ...
        Relationships: [
          {
            foreignKeyName: "tenant_subjects_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
    ...
    Views: {
      class_textbook_stats: {
        Row: {
          classes_with_both_textbooks: number | null
          classes_with_main_textbook: number | null
          classes_with_supplementary_textbook: number | null
          tenant_id: string | null
    ...
    Enums: {
      ...
      classroom_change_reason:
        ...
        | "administrative"
        | "other"
      classroom_status: "available" | "occupied" | "maintenance" | "reserved"
      classroom_type:
        | "general"
        | "lab"
        | "seminar"
