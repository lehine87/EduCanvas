...
export const StudentListItem = memo<StudentListItemProps>(({
  student,
  onClick,
  onSelect,
  isSelected = false,
    ...
    >
      ...
      <div 
        className={cn(
          ...
          statusStyles[student.status as keyof typeof statusStyles] || statusStyles.inactive
        )}
      />
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2 mb-1">
              ...
              <Badge 
                ...
                className={cn(
                  "text-xs",
                  statusBadgeStyles[student.status as keyof typeof statusBadgeStyles]
                )}
              >
