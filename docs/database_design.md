...
| 테이블 | 용도 |
|--------|------|
| `course_packages` | 클래스별 다양한 수강권 옵션 |
| `discount_policies` | 할인 정책 관리 |
| `student_enrollments` | 학생별 수강권 등록 및 사용량 추적 |
| `salary_policies` | 강사 급여 정책 정의 |
