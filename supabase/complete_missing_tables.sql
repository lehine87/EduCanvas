-- ================================================================
-- EduCanvas T-003 완료를 위한 누락 테이블 추가 스크립트
-- 작성일: 2025-08-10
-- 목적: Schema v4.1에 정의된 모든 누락 테이블 추가
-- ================================================================
...
-- 기존 videos 테이블을 video_lectures로 확장하기 위한 새 테이블들
...
BEGIN
    RAISE NOTICE '==================================================';
    RAISE NOTICE 'EduCanvas T-003 누락 테이블 추가 완료!';
    RAISE NOTICE '==================================================';
